              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildStatItem(
                          '${authUser.userData['states'] ?? '0'}', 'States', Colors.cyan),
                      _buildStatItem(
                          '${authUser.userData['countries'] ?? '0'}', 'Countries', Colors.blue),
                      _buildStatItem(
                          '${authUser.userData['continents'] ?? '0'}', 'Continents', Colors.purple),
                    ],
                  ),
                ),
              ),
